...
function Loader( editor ) {
		...
		switch ( extension ) {
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setLibraryPath( '../threejs/jsm/libs/rhino3dm/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.setDecoderPath( '../threejs/jsm/libs/draco/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { PCDLoader } = await import( '../../threejs/jsm/loaders/PCDLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { USDZLoader } = await import( '../../threejs/jsm/loaders/USDZLoader.js' );
	...
	async function createGLTFLoader( manager ) {
		...
		ktx2Loader.setTranscoderPath( '../threejs/jsm/libs/basis/' );
